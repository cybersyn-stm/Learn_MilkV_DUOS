...
#ifdef CONFIG_PRINTK
asmlinkage __printf(4,
		    0) int vprintk_emit(int facility, int level,
...
extern int devkmsg_sysctl_set_loglvl(struct ctl_table *table, int write,
...
#if defined(CONFIG_DYNAMIC_DEBUG) ||                                           \
	(defined(CONFIG_DYNAMIC_DEBUG_CORE) && defined(DYNAMIC_DEBUG_MODULE))
#define print_hex_dump_debug(prefix_str, prefix_type, rowsize, groupsize, buf, \
			     len, ascii)                                       \
	dynamic_hex_dump(prefix_str, prefix_type, rowsize, groupsize, buf,     \
			 len, ascii)
#elif defined(DEBUG)
#define print_hex_dump_debug(prefix_str, prefix_type, rowsize, groupsize, buf, \
			     len, ascii)                                       \
